...
class YourRepository @Inject constructor(
    ...
    override suspend fun postAuthProfile(profileLoginAuthRequest: EmailPasswordIsSupervisorPushId):authResult<Unit> = SignupEndpoint.postProfileAuth(profileLoginAuthRequest)
